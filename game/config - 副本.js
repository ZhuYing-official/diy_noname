window.config={
	...
	characters:['standard','shenhua','sp','sp2','yijiang','refresh','xinghuoliaoyuan','mobile','extra','yingbian','offline','old','tw','sb','clan'],
	connect_characters:['diy'],
	connect_cards:['huanlekapai','guozhan','sp','zhulu','yingbian','yongjian'],
	plays:[],
	extensions:['SJ Settings','XwTool','2-17人','十周年UI','手杀ui'],
	banned:[],
	bannedcards:[],
	forbidlist:[],
	bannedpile:{},
