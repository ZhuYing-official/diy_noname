window.config = {
	...
	forbidai_user: [],
	forbidall: [],
	forbidstone: ["zhugedan", "hs_malfurion", "lusu", "chenlin", "hs_siwangzhiyi", "yuanshao", "daqiao", "re_daqiao", "hs_xuanzhuanjijia", "zhuran", "huatuo", "hs_guldan", "wangyi", "caoang", "re_guojia", "shen_caocao", "caopi", "hs_yngvar", "guansuo", "hs_anduin", "hs_antonidas", "xushi", "hs_lreno"],
	...
	moderned_chracters: ["standard", "shenhua", "sp", "sp2", "yijiang", "newjiang", "sixiang", "refresh", "mobile", "extra", "yingbian", "sb", "tw", "offline", "clan", "collab", "xianding", "huicui", "shiji", "onlyOL", "jsrg", "old", "diy", "ddd"],
