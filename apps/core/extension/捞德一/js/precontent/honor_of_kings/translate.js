const translates = {
	...
	hok_taigua: '泰卦',
	hok_taigua_info: '蓄力技（1/3）。①每回合限一次，你可以消耗3点蓄力值，对师卦目标造成1点伤害，令临卦目标回复1点体力。若师卦和临卦只有一个目标存在，则只对该目标执行效果，且你失去1点体力。若师卦目标死亡，你获得2点蓄力值。②你造成非此技能的伤害时，获得1点蓄力值。',
	// 芈月
	hok_miyue: '王者芈月',
	hok_shengxue: '生血',
	...
	hok_anyue: '暗月',
	hok_anyue_info: '出牌阶段，你的“蝠”标记等于4时，你可以弃置4枚“蝠”标记对“暗链”目标造成一点伤害，然后令你不可选中直到你的下个回合开始时。',
	// 墨子
	hok_mozi: '王者墨子',
